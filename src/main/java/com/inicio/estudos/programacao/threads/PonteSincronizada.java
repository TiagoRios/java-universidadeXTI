...
public class PonteSincronizada implements Ponte{
	...
	public synchronized void set(int valor) throws InterruptedException {	
		//quando a condi�ao nao for mais verdadeira pode executar a inclusao da informa�ao usando este metodo 
		while (ocupada) {
		...
		ocupada = true;
		//notifica as thread que estao aguardando a modifica��o do estatus mudou ou nao(ocupado ou desocupado
		notifyAll();
	}
